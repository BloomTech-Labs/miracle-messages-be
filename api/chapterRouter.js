...
router.post("/:chapterId/register", authenticationRequired, userInfo, async (req, res) => {
...
//Update: chapter info
router.put("/:chapterId",authenticationRequired, userInfo, adminCheck, async (req, res) => {
  try {
...
router.delete("/:chapterId", authenticationRequired, userInfo, adminCheck, (req, res) => {
    const chapterId = req.params.chapterId;
